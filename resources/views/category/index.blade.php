...
@section('content')
    ...
    <script>
        ...
        const BASE = '{{ url("categories") }}';

        function showNewForm() { document.getElementById('newCategoryForm').style.display = 'block'; }
        function hideNewForm() { document.getElementById('newCategoryForm').style.display = 'none'; }

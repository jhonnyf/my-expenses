                    ...
                    <div class="kt-menu flex flex-col grow gap-1" data-kt-menu="true"
                            ...
                            <div
                                ...
                                <div class="kt-menu-item" data-kt-menu-item-toggle="accordion"
                                    ...
                                    <div
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link border border-transparent items-center grow kt-menu-item-active:bg-accent/60 dark:menu-item-active:border-border kt-menu-item-active:rounded-lg hover:bg-accent/60 hover:rounded-lg gap-[5px] ps-[10px] pe-[10px] py-[8px]"
                                                href="html/demo1/account/members/team-members-datatable.html"
                                                tabindex="0">
                                                <span
                                                    class="kt-menu-bullet flex w-[6px] -start-[3px] rtl:start-0 relative before:absolute before:top-0 before:size-[6px] before:rounded-full rtl:before:translate-x-1/2 before:-translate-y-1/2 kt-menu-item-active:before:bg-primary kt-menu-item-hover:before:bg-primary">
                                                </span>
                        ...
                        <div class="kt-menu-item" data-kt-menu-item-toggle="accordion"
                            ...
                            <div
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link border border-transparent items-center grow kt-menu-item-active:bg-accent/60 dark:menu-item-active:border-border kt-menu-item-active:rounded-lg hover:bg-accent/60 hover:rounded-lg gap-[14px] ps-[10px] pe-[10px] py-[8px]"
                                        href="html/demo1/authentication/welcome-message-2.html" tabindex="0">
                                        <span
                                            class="kt-menu-bullet flex w-[6px] -start-[3px] rtl:start-0 relative before:absolute before:top-0 before:size-[6px] before:rounded-full rtl:before:translate-x-1/2 before:-translate-y-1/2 kt-menu-item-active:before:bg-primary kt-menu-item-hover:before:bg-primary">
                                        </span>
                                        <span
                        ...
                        <div class="kt-menu-item">
                            <a class="kt-menu-link gap-[10px] ps-[10px] pe-[10px] py-[6px] border border-transparent kt-menu-item-active:bg-accent/60 dark:menu-item-active:border-border kt-menu-item-active:rounded-lg hover:bg-accent/60 hover:rounded-lg"
                                href="html/demo1/plugins/fullcalendar.html" tabindex="0">
                                <span
                                    class="kt-menu-icon items-start text-muted-foreground kt-menu-item-active:text-primary kt-menu-link-hover:!text-primary w-[20px]">
                                            ...
                                            <div class="flex flex-col lg:flex-row">
                                                ...
                                                <div
                                                    ...
                                                    <div class="kt-menu kt-menu-default kt-menu-fit flex-col">
                                                        ...
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link border border-transparent kt-menu-link-hover:!bg-background kt-menu-link-hover:border-border kt-menu-item-active:!bg-background kt-menu-item-active:border-border"
                                                                href="html/demo1/authentication/welcome-message-2.html">
                                                                <span class="kt-menu-icon">
                                                                    <i class="ki-filled ki-element-11">
                                                                    </i>
                                                                </span>
                                        ...
                                        <div class="kt-menu-dropdown kt-menu-default py-2.5 w-full max-w-[220px]">
                                            ...
                                            <div class="kt-menu-item" data-kt-menu-item-placement="right-start"
                                                ...
                                                <div
                                                    ...
                                                    <div class="kt-menu-item">
                                                        <a class="kt-menu-link"
                                                            href="https://devs.keenthemes.com/popular" tabindex="0">
                                                            <span class="kt-menu-icon">
